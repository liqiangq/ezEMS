...
import com.thtf.service.MultiChartService;
...
@RemotingDestination
public class MultiChartServiceImp extends BasicServiceImp implements
		MultiChartService {

	private static Logger logger = Logger.getLogger(ChartServiceImp.class);
	...
	private String buildSQL(String date, String dateType,String tableName, List<String> itemIds,boolean isShowName,String itemName,String chartType,String  dataType){
		...
		sql_b2.append(" f.id=a.sub_floor_id and f.name='" + itemName.trim()+"'"
		...
		if(!isShowName){
				...
				if("pie".equals(chartType)){
					...
					for(int i =0 ; i<24 ; i++){
						if(i!=0)
							s_param.append(",");
						if(i<10)
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,12,2)='0"+i+"' then  round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,13)='"+date+" 0"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,12,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,13)='"+date+" "+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
				...
				if("pie".equals(chartType)){
					...
					for (int i = 1; i < DateUtil.maxMonth(date, "yyyy-MM-dd")+1 ; i++){
						if(i!=1)
							s_param.append(",");
						if(i<10)
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,9,2)='0"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,10)='"+date.substring(0, 7)+"-0"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,9,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,10)='"+date.substring(0, 7)+"-"+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
				...
				if("pie".equals(chartType)){
					...
					for (int i = 1; i < 13 ; i++){
						if(i!=1)
							s_param.append(",");
						if(i<10)
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,6,2)='0"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,7)='"+date.substring(0, 4)+"-0"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							s_param.append(" CONCAT(sum((CASE when substring(t1.date_time,6,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,7)='"+date.substring(0, 4)+"-"+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
			...
			if("day".equals(dateType)){
				if("pie".equals(chartType)){
					...
					for(int i =0 ; i<24 ; i++){
						if(i<10)
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,12,2)='0"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,13)='"+date+" 0"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,12,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,13)='"+date+" "+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
				where.append(" substring(t1.date_time,1,10)='"+date+"' ");
			}else if("month".equals(dateType)){
				if("pie".equals(chartType)){
					...
					for (int i = 1; i < DateUtil.maxMonth(date, "yyyy-MM-dd")+1 ; i++){
						if(i<10)
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,9,2)='0"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,10)='"+date.substring(0, 7)+"-0"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,9,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,10)='"+date.substring(0, 7)+"-"+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
				where.append(" substring(t1.date_time,1,7)='"+date.substring(0, 7)+"' ");
			}else if("year".equals(dateType)){
				if("pie".equals(chartType)){
					...
					for (int i = 1; i < 13 ; i++){
						if(i<10)
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,6,2)='0"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,7)='"+date.substring(0, 4)+"-"+i+"' then t1.error end)) as '0"+i+"' ");
						else
							param.append(" ,CONCAT(sum((CASE when substring(t1.date_time,6,2)='"+i+"' then round("+strType+"/"+s+",4)*1000 end) ),'-',GROUP_CONCAT(CASE when substring(t1.date_time,1,7)='"+date.substring(0, 4)+"-"+i+"' then t1.error end)) as '"+i+"' ");
					}
				}
				where.append(" substring(t1.date_time,1,4)='"+date.substring(0, 4)+"' ");
			}
		...
		for(int i = 0 ; i < result.size() ; i++){
			...
			if(!"pie".equals(chartType)){
				for(String s:xaxisValues){//设置统计X轴内容
					String sp = map.get((Integer.parseInt(s)+1)+"");
